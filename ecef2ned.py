...
class NED:
    def __init__(self, lat, lon, height):
        """ Crea un plano en ned centrada en lat, lon, altitude  """
        # Constantes definidas por WSG..)
        self.a = 6378137
        self.b = 6356752.3142
        ...
        # Save NED origin Guardando NED origen
    ...
    def ecef2ned(self, ecef):
        """Convierte de ECEF a NED y regresa una tupla).
        """
...
def degreeMinute2Degree(lat, lon):
        """ Transforma la latitud y longitud en el formato
            DDDMM.MM al formato DDD.DD """
...
def __splitDegreeMinutes__(value):
    """ Transforma de DDDMM.MM a DDD, MM.MM """
    val = str(value).split('.')
